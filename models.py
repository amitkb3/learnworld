...
# tip: cascade delete : https://stackoverflow.com/questions/5033547/sqlalchemy-cascade-delete
...
class Lesson(db.Model):
  ...
  lesson_summary = db.Column(sb.String(100))
  cards = db.relationship('Card', backref='lesson', lazy=True, passive_deletes=True)
